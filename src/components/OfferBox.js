  ...
  return (
    <>
      <div className="flex content-center rounded-xl items-center flex-col w-full bg-neutral-900 text-white shadow-xl p-6">
        <div className="w-full rounded-xl flex content-center items-center  p-5">
          <div className="w-full flex content-center items-center">
            ...
            className="w-[5rem] h-[5rem] rounded-full"
              ...
              alt="img"
            />
            <span className="pl-7 text-2xl font-bold tracking-tight leading-tight text-teal-500">Ankur Yadav</span>
          </div>
        ...
        <div className="flex content-center items-center">
          <div className="w-fit text-xl flex content-center items-center hover:text-gray-500 cursor-pointer">
            <Link href="/patient/checkout"><span className=" text-xl pl-2"><button className='text-md p-3 w-full font-medium bg-teal-700 rounded-xl text-white '> Accept</button></span></Link>
