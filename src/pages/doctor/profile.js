              ...
              <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                  ...
                  <div className="flex flex-row m-4">
                    ...
                    <input className="appearance-none block w-full bg-neutral-700 text-white rounded py-3 px-4 leading-tight focus:outline-none focus:bg-neutral-700 focus:border-gray-500" id="grid-password" type="link" />
                  </div>
                  ...
                  <div className="flex flex-row m-4">
                    ...
                    <input className="appearance-none block w-full bg-neutral-700 text-white rounded py-3 px-4 leading-tight focus:outline-none focus:bg-neutral-700 focus:border-gray-500" type="link" />
                  </div>
