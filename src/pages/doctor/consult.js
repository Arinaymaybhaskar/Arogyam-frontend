  ...
  return (
    <>
      <div className=" h-screen flex flex-col">
        <Navbar />
        <div id="heading" className="p-20 pl-12 text-7xl font-bold -tracking-tightest leading-tight bg-neutral-900 text-white"><p>Your <span className="text-teal-700">Consultations</span></p></div>
            ...
            return (
              <>
                <div className="w-[25rem] flex content-center items-center bg-neutral-900 text-white shadow-xl flex-col  rounded-xl">
                    ...
                    <div className="w-full flex content-center items-center">
                      <div className="w-full content-center items-center flex flex-row">
                        <img
                          ...
                          alt="img" />
                        <span className="w-full p-[0.5rem] pl-4 font-medium -tracking-tight leading-tight">Ankur Yadav</span>
                      </div>
                  ...
                  <div className="flex content-evenly w-full bg-neutral-950 p-5 rounded-xl">
                    <div className="w-fit text-xl flex content-center items-center hover:text-gray-600 cursor-pointer">
                      <span className="text-lg ">
                        <button className='text-md mx-6 w-full rounded-xl text-white my-0 flex flex-row font-bold tracking-tight leading-tight '>
                    ...
                    <div className="w-fit text-xl flex content-center items-center hover:text-gray-600 cursor-pointer">
                      <span className="text-lg ">
                        <button className='text-md w-full rounded-xl text-white my-0 flex flex-row font-bold tracking-tight leading-tight '>
                          <FcShare className="text-2xl ml-4 " />
                          Share
                        </button>
                      </span>
                    </div>
