    ...
    return (
        <>
            ...
            {/* <div className="flex content-center items-center">
                <div id="image" className="w-1/2"> </div>
                <form className="h-screen w-1/2 flex content-center items-center flex-col gap-3 p-8 bg-neutral-800" action="" >
                    <div className="text-4xl text-center">AROGYAM</div>
                    <input
                        className="w-full bg-transparent p-2 border-0 text-lg border-b-[1px] border-b-black "
                        type="email"
                        placeholder="Email"
                        name="email"
                    />
                    <input
                        className="w-full bg-transparent p-2 border-0 text-lg border-b-[1px] border-b-black focus: "
                        type="password"
                        placeholder="Password"
                        name="password"
                    />
                    <button className="w-full p-4 border-none font-semibold rounded-lg text-md bg-black text-white mt-4 cursor-pointer" type="submit">
                        SIGN IN
                    </button>
                    <button
                        className="w-full p-4 font-semibold rounded-lg text-md bg-transparent border-[1px] border-black"
                        type="submit"
                    >
                        Sign In with Google
                    </button>
                    <span className="text-">
                        ...
                        Don't have an account ? <Link className="font-semibold" href="/register">CREATE ONE</Link>
                    </span>
                </form>
            </div> */}
        </>
